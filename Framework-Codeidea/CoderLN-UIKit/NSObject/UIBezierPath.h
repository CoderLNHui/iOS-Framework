...
#pragma mark - 创建并且返回一个新的 UIBezierPath 对象
...
#pragma mark - 画圆（width = height）、画椭圆（width != height）
/**
...
#pragma mark - 通过一个 CGPath, 创建并且返回一个新的 UIBezierPath 对象
...
#pragma mark - 画三次贝塞尔曲线（由两个控制点来控制）
/**
...
#pragma mark - 画二次贝塞尔曲线（由一个控制点来控制）
/**
...
#pragma mark - 移除 UIBezierPath 对象中的所有点, 效果也就等同于移除所有子路经
...
// Modified paths
#pragma mark - 创建并返回一个新的BezierPath, 这个 BezierPath 的方向是原 BezierPath 的反方向
/*
...
// Transforming paths
#pragma mark - 该方法将会直接对路径中的所有点进行指定的放射
/**
 * Apply Transform
 * 变换操作.
 */
