...
#pragma mark - 设置通知显示的内容
// timer-based scheduling
#pragma mark -设置通知发出的时间
...
#pragma mark -时区，一般不需要设置
@property(nullable, nonatomic,copy) NSTimeZone *timeZone;

#pragma mark -通知的重复间隔，枚举
...
#pragma mark -区域:当进入该区域时,就会发出一个通知
...
#pragma mark -YES:进入某一个区域只会发出一次通知.NO:每次进入该区域都会发出通知
